        ...
        <div class="intro__item">
            @foreach ($banner as $item)
                <div class="intro__fon">
                    <video class="intro__v-fon" src="{{ Vite::asset('resources/media/images/') . $item->background }}" autoplay
                        muted loop></video>
                </div>
                <div class="intro__content">
                    ...
                    <h1 class="intro_text_h1 _anim-items fs-vb"
                        style=" text-shadow: 0 0 10px #fff; font-weight: bold; letter-spacing: 0px;">{{ $heading_1 }}</h1>
                    <h4 class="intro_text_h4 _anim-items fs-m"
                        style=" text-shadow: 0 0 10px #fff; font-weight: bold; letter-spacing: 10px;">{{ $heading_2 }}</h4>
            ...
            <div id="app-cover">
                ...
                <div id="player">
                    ...
                    <div id="player-content">
                        <div id="album-art">
                            <img src="{{ Vite::asset('resources/media/images/SkYClbKLcb0.jpg') }}" class="active"
                                id="_1">
                            <img src="{{ Vite::asset('resources/media/images/kD9twhD52Ow.jpg') }}" id="_2">
            ...
            <div class="main-slider-section">
                <div class="main-slider swiper-container swiper-container-horizontal">
                                    ...
                                    <div class="cardbbb">
                                        <div id="aaaddd" class="card-1">
                                            <div class="card-img6-1"
                                                style="background-image: url({{ Vite::asset('resources/media/images/') . $item->image }})">
                                            </div>
                                        </div>
                                        <div class="card-text">
                    ...
                    <div class="swiper-button-prev uploaded-in-prev"
                        style="background-image: url({{ Vite::asset('resources/media/images/Vector_6.svg') }});"></div>
                    <div class="swiper-button-next uploaded-in-next swiper-button-disabled"
                        style="background-image: url({{ Vite::asset('resources/media/images/Vector_7.svg') }});"></div>
                </div>
            </div>
        </div>
    </div>
