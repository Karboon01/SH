    ...
    <div class="intro slider">
        <div class="intro__item">
            <div class="intro__fon">
                <video class="intro__v-fon" src="{{ Vite::asset('resources/media/images/Travis_scott.mp4') }}" autoplay muted loop></video>
            </div>
            ...
            <div id="app-cover">
                ...
                <div id="player">
                    ...
                    <div id="player-content">
                        <div id="album-art">
                            <img src="{{ Vite::asset('resources/media/images/SkYClbKLcb0.jpg') }}" class="active" id="_1">
        ...
        <div class="wrapper"  >
            <div class="main-slider-section">
                <div class="main-slider swiper-container swiper-container-horizontal">
                    ...
                    <div class="swiper-button-prev uploaded-in-prev" style="background-image: url({{ Vite::asset('resources/media/images/Vector_6.svg') }});"></div>
                    <div class="swiper-button-next uploaded-in-next swiper-button-disabled" style="background-image: url({{ Vite::asset('resources/media/images/Vector_7.svg') }});"></div>
                </div>
            </div>
        </div>
    </div>
