<nav class="nav">
    <div class="nav__container">
        <div class="nav__logo">
            <a href="/">
                <img src="{{ Vite::asset('resources/media/images/logo/SHREE.svg') }}" alt="Logo">
            </a>
        </div>
            ...
            <div class="nav__container">
                <div id="nav__List" class="nav__list">
                    <ul class="nav__links">
                        ...
                        <li>
                            <a href="/admin_label">LABEL</a>
                        </li>
                        <li>
                            <a href="/admin_services">SERVICES</a>
                        </li>
                        <li>
                            <a href="/admin_studio">STUDIO</a>
                        </li>
                        <li>
                            <a href="/admin_banners">BANNER</a>
                        </li>
                        <li>
                            <a href="/admin_socials">SOCIAL</a>
                        </li>
                        <li>
